...
1. **タスク1-4**: 基盤となる型定義、ユーティリティ、フック、Contextを実装
2. **タスク5**: 共通UIコンポーネントを実装
3. **タスク6**: Start画面を実装
4. **タスク7-9**: Game画面の各機能を段階的に実装
5. **タスク10-12**: Setting画面の各機能を段階的に実装
6. **タスク13**: ルーティングを統合
7. **タスク14-15**: スタイリングとBGM機能を追加
8. **タスク16-17**: エラーハンドリングとサンプルデータを追加
9. **タスク18-19**: テストと最適化（オプション）
10. **タスク20**: 最終統合とデバッグ
