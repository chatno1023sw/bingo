    ...
    <header className="fixed top-0 left-0 z-100 w-full bg-background py-2 shadow">
      <div className="flex flex-wrap items-center justify-between gap-3 px-8">
        <div className="flex flex-wrap items-center gap-2">
          <Button
            type="button"
            className="rounded bg-primary px-3 py-1.5 text-primary-foreground text-xs shadow-none disabled:opacity-50"
            onClick={onAddCard}
            disabled={isMutating}
          >
            追加
          ...
          <Button
            type="button"
            variant="outline"
            className="rounded border border-border px-3 py-1.5 text-secondary-foreground text-xs shadow-none hover:bg-muted disabled:opacity-50"
