...
export class DataService1 {
  ...
  getUser(id: string): Observable<User> {
    return this.http
      ...
      .pipe(map(this.transformUser), catchError(this.handleError));
  }
  ...
  getProduct(id: string): Observable<Product> {
    return this.http
      ...
      .pipe(map(this.transformProduct), catchError(this.handleError));
  }
  ...
  getOrder(id: string): Observable<Order> {
    return this.http
      .get<Order>(`${this.baseUrl}/orders/${id}`)
      .pipe(map(this.transformOrder), catchError(this.handleError));
  }

  createOrder(data: Partial<Order>): Observable<Order> {
    return this.http
      .post<Order>(`${this.baseUrl}/orders`, data)
      .pipe(map(this.transformOrder), catchError(this.handleError));
  }
  ...
  getCategorys(): Observable<Category[]> {
    return this.http.get<Category[]>(`${this.baseUrl}/categorys`).pipe(
  ...
  getCategory(id: string): Observable<Category> {
    return this.http
      .get<Category>(`${this.baseUrl}/categorys/${id}`)
      .pipe(map(this.transformCategory), catchError(this.handleError));
  }

  createCategory(data: Partial<Category>): Observable<Category> {
    return this.http
      .post<Category>(`${this.baseUrl}/categorys`, data)
      .pipe(map(this.transformCategory), catchError(this.handleError));
  }
  ...
  getReview(id: string): Observable<Review> {
    return this.http
      .get<Review>(`${this.baseUrl}/reviews/${id}`)
      .pipe(map(this.transformReview), catchError(this.handleError));
  }

  createReview(data: Partial<Review>): Observable<Review> {
    return this.http
      .post<Review>(`${this.baseUrl}/reviews`, data)
      .pipe(map(this.transformReview), catchError(this.handleError));
  }
